...
if __name__ == "__main__":
    ...
    report_leaf = ReportLeaf("Stervormig", "Massa", 0.7, {"Irregular": 0.8, "Circumscribed": 0.4}, "Hint")
    test_tree = ReportNode("Birads", [report_leaf], ["Architectural distorsion", "Breast composition"])
