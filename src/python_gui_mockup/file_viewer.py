...
try:
    ...
    from Tkconstants import HORIZONTAL, VERTICAL, END
except ImportError:
    from tkinter.ttk import Treeview, Scrollbar, Frame
    from tkinter.constants import HORIZONTAL, VERTICAL, END
...
class File_Viewer(Frame):
    def __init__(self, master, xml=None, heading_anchor=None, padding=None, cursor=None, takefocus=None, style=None):
        Frame.__init__(self, master, class_="File_Viewer")
        ...
        self._vsb.grid(column=1, row=0, sticky="NS")
        self._hsb.grid(column=0, row=1, sticky="EW")
    ...
    def _on_close(self, event):
        ...
        text = self._repr_of_openning_tag(node)
